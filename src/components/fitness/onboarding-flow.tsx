...
function WelcomeScreen({ onNext }: { onNext: () => void }) {
  return (
    ...
    >
      ...
      >
        <div className="w-24 h-24 rounded-3xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center shadow-xl shadow-emerald-500/30">
          <Activity className="w-12 h-12 text-white" />
        </div>
        <motion.div
          className="absolute -inset-4 rounded-[2rem] border-2 border-emerald-500/20"
      ...
      >
        <Button
          onClick={onNext}
          className="w-full h-14 rounded-2xl text-lg font-semibold bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 shadow-lg shadow-emerald-500/25"
        >
          Get started
    ...
    >
      ...
      <div className="space-y-3 pt-6">
        <Button
          ...
          className="w-full h-14 rounded-2xl text-lg font-semibold bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600"
        >
          Continue
          <ChevronRight className="w-5 h-5 ml-1" />
        </Button>
            ...
            return (
              <motion.button
                ...
                className={cn(
                  ...
                  isSelected
                    ? `bg-gradient-to-r ${config.gradient} border-2 border-emerald-500`
...
function BaselineScreen({
  ...
  const handlePhotoUpload = () => {
    ...
    onUpdate({ 
      ...
      progressPhotoUrl: "/placeholder-photo.jpg" 
    });
  };
...
function PostOnboardingPrompt({
  ...
  return (
    ...
    >
      <Card className="rounded-3xl shadow-2xl border-0 bg-gradient-to-br from-slate-900 to-slate-800 text-white overflow-hidden">
