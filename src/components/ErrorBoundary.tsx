      ...
      return (
        ...
        >
          <motion.div
            initial={{ scale: 0.8 }}
            animate={{ scale: 1 }}
            className="w-16 h-16 rounded-2xl bg-gradient-to-br from-rose-100 to-amber-100 dark:from-rose-950/50 dark:to-amber-950/50 flex items-center justify-center mb-4"
          >
