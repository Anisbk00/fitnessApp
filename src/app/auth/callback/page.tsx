  ...
  return (
    ...
    >
      {status === 'loading' && (
        <>
          <motion.div
            className="w-16 h-16 mx-auto rounded-2xl bg-gradient-to-br from-emerald-400 to-teal-500 flex items-center justify-center shadow-lg shadow-emerald-500/25"
            animate={{ rotate: 360 }}
